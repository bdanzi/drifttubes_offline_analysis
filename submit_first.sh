...
#runinputsevents_2_gsample=("9" "10") # Study July 2022 Test Beam Runs with different Sampling rate: 1.5 2.0
...
for cut_scale in 0.26 #0.22 0.24 0.26 0.28 #0.1 0.4 0.5 #con N_2 1.0 # second derivative in the peak candidate
do
    for N_1 in 10.0 #6 # Amplitude cut
    do
        for N_2 in 1.0 # 1.5 1.2 0.8 0.5 1.0 amplitude on the average before and after the peak candidate
        do
            for N_3 in 0.2 #0.1 0.4 0.5 #con N_2 1.0 # first derivative in the peak candidate
            do
                for N_4 in 0.2 #0.1 0.4 0.5 #con N_2 1.0 # second derivative in the peak candidate
                do
                for gsample in 0 2
                    do
                        runinputs=()
