...
runinputs10000events=("91")
runinputs5000events=("94" "96" "98" "99" "127" "117")
    ...
    do
      ...
      then
        ...
        for i in ${runinputs[@]}
            ...
            echo "cd /lustrehome/bdanzi/latest/CMSSW_10_2_22/src/HiggsAnalysis/HiggsToZZ4Leptons/test/" >> ${path}/submit_executable_conversion$i.sh
            ...
            echo "./read_data . $i 0 -$nevents 1" >> ${path}/submit_executable_conversion$i.sh
