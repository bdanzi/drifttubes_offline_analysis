...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMax_chdata_x742 = 22;
   ...
   virtual void     Loop(Char_t *name, Int_t MidEv=0,Int_t eventn=-1, Bool_t evalWaveCut=false,TString fOutName="Full_Wave.txt");
